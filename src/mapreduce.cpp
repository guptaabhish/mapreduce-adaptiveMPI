...
__thread MapReduce *MapReduce::mrptr;
__thread int MapReduce::instances_now = 0;
__thread int MapReduce::instances_ever = 0;
__thread int MapReduce::mpi_finalize_flag = 0;
__thread uint64_t MapReduce::msize = 0;
__thread uint64_t MapReduce::msizemax = 0;
__thread uint64_t MapReduce::rsize = 0;
__thread uint64_t MapReduce::wsize = 0;
__thread uint64_t MapReduce::cssize = 0;
__thread uint64_t MapReduce::crsize = 0;
__thread double MapReduce::commtime = 0.0;
